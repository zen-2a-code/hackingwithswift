...
struct AdditionalSettingsLoadingMultiplePhotosFromUsersPhotoLibraryView: View {
    @State private var pickerItems: [PhotosPickerItem] = [PhotosPickerItem]()
    @State private var selectedImages = [Image]()
    
    var body: some View {
        VStack {
//            PhotosPicker("Select an image", selection: $pickerItems, maxSelectionCount: 3, matching: .images)
